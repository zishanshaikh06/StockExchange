...
public class MatchEngine_Old implements IMatchEngine {
            ...
            while ((orderBook.getQuantity().getQuantity() > 0)) {
                ...
                if ((order != null) && (order.getPrice().getPrice() < orderBook.getPrice().getPrice())) {
                    ...
                    if (order.getQuantity().getQuantity() >= orderBook.getQuantity().getQuantity()) {
                        ...
                        Double fQuant = order.getQuantity().getQuantity() - orderBook.getQuantity().getQuantity();

                        Double remQuant = order.getQuantity().getQuantity() - fQuant - orderBook.getQuantity().getQuantity();

                        Double soldQ = order.getQuantity().getQuantity() - fQuant;
                        ...
                        Double fQuant = orderBook.getQuantity().getQuantity() - order.getQuantity().getQuantity();

                        Double remQuant = orderBook.getQuantity().getQuantity() - fQuant - order.getQuantity().getQuantity();

                        Double soldQ = orderBook.getQuantity().getQuantity() - fQuant;
